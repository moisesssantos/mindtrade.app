...
return (
  <>
    ...
    {/* ===== Modal de Conclusão ===== */}
    {confirmConcluir && (
      <Dialog open={true} onOpenChange={setConfirmConcluir}>
        <DialogContent className="sm:max-w-[420px]">
          ...
          <div className="space-y-3">
            <p className="text-sm text-muted-foreground">
              Ao concluir, a operação será marcada como <strong>Concluída</strong> e
              o status da partida será atualizado. 
            </p>

            {itensPendentes > 0 && (
              <div className="text-xs text-amber-600">
                {itensPendentes} item(ns) ainda sem Resultado Financeiro.
              </div>
            )}
          </div>

          <div className="flex justify-end gap-2 pt-2">
            <Button variant="outline" onClick={cancelarConclusao}>
              Cancelar
            </Button>
            <Button
