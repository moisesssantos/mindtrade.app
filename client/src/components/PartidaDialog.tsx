...
export function PartidaDialog({
  ...
  const schema = z.object({
    ...
    competicaoId: z
      .number({ required_error: "Competição é obrigatória" })
      .int()
      .positive(),
    mandanteId: z
      .number({ required_error: "Mandante é obrigatório" })
      .int()
      .positive(),
    visitanteId: z
      .number({ required_error: "Visitante é obrigatório" })
      .int()
      .positive(),
  ...
  useEffect(() => {
    if (open) {
      form.reset({
        ...
        oddMandante:
          initialData?.oddMandante !== undefined ? initialData.oddMandante : "",
        oddVisitante:
          initialData?.oddVisitante !== undefined ? initialData.oddVisitante : "",
        oddEmpate:
          initialData?.oddEmpate !== undefined ? initialData.oddEmpate : "",
      });
    }
  ...
  return (
    ...
    >
      <DialogContent className="max-w-3xl">
        <DialogHeader>
          <DialogTitle>
            {initialData?.id ? "Editar Partida" : "Nova Partida"}
          </DialogTitle>
          <DialogDescription>
